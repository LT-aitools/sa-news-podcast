...
def create_podcast_summary(newsletter_content, rss_content, max_retries=3):
    ...
    Do not include any sound effects or music besides "intro music" at the beginning, "outro music" at the end, and "transition music" between news stories--which should be written as **intro music**, **transition music**, or **outro music** in the transcript.
